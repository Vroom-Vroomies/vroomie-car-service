...
public enum ErrorCode {
    ...
    CAR_NOT_AVAILABLE("차량이 대여 불가능한 상태입니다", 1003, HttpStatus.BAD_REQUEST),
    ...
    INVALID_TIME_SLOT("30분 단위 시간대만 예약 가능합니다.", 1303, HttpStatus.BAD_REQUEST),
    ...
    PAST_DATETIME_NOT_ALLOWED("과거 시간대는 선택할 수 없습니다.", 1310, HttpStatus.BAD_REQUEST),
